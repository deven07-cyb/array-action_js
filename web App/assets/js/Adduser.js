...
function readFormData() {
  var birthdate = new Date( document.getElementById("fdate").value );
  var today = new Date();
  ...
  let userDataRecord = localStorage.getItem("userData") !== null ? JSON.parse(localStorage.getItem("userData")) : [];
  if (userDataRecord.some((element) => element.User_id == document.getElementById("lid").value)) 
  {
...
function onDelete(td, id) {
  if (confirm("Are you sure to delete this record ?")) {
    ...
    let userDataRecord =localStorage.getItem("userData") !== null ? JSON.parse(localStorage.getItem("userData")) : [];
    var newProductData = userDataRecord.filter((element) => element.User_id != id);
    localStorage.setItem("userData", JSON.stringify(newProductData));
    put_table_data();
  }
}